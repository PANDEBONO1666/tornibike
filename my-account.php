...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $num = mysqli_num_rows($sql); // Corregido
        if ($num > 0) {
                                                ...
                                                <div class="row">
                                                            <div class="col-md-8">
                                                                        <div class="panel-group checkout-steps"
                                                                                    ...
                                                                                    <!-- checkout-step-02  -->
                                                                                    <div
                                                                                                class="panel panel-default checkout-step-02">
                                                                                                <div
                                                                                                            class="panel-heading">
                                                                                                            <h4
                                                                                                                        class="unicase-checkout-title">
                                                                                                            ...
                                                                                                            <div
                                                                                                                        ...
                                                                                                                        <form class="register-form"
                                                                                                                                    ...
                                                                                                                                    <div
                                                                                                                                                class="form-group">
                                                                                                                                                <label class="info-title"
                                                                                                                                                            for="Current Password">Contraseña
                                                                                                                                    ...
                                                                                                                                    <button type="submit"
                                                                                                                                                name="submit"
                                                                                                                                                class="btn-upper btn btn-primary checkout-page-button">Cambio
                                                                                                                                    </button>
                                                                                                                        </form>

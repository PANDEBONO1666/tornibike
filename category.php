                                                ...
                                                <div class='col-md-3 sidebar'>
                                                            ...
                                                            <div class="side-menu animate-dropdown outer-bottom-xs">
                                                                        <div
                                                                                    ...
                                                                                    <div class="head"><i
                                                                                                            class="icon fa fa-align-justify fa-fw"></i>Sub
                                                                                                Categorías</div>
                                        ...
                                        ?>
                                                                                                                        <a href="sub-category.php?scid=<?php echo $row['id']; ?>"
                                                                                                                                    class="dropdown-toggle"><i
                                                                                                                                                class="icon fa fa-bicycle fa-fw"></i>
                                                            ...
                                                            <div class="sidebar-module-container">
                                                                        ...
                                                                        <div class="sidebar-filter">
                                                                                    <!-- ============================================== SIDEBAR CATEGORY ============================================== -->
                                                                                    <div
                                                                                                class="sidebar-widget wow fadeInUp outer-bottom-xs ">
                                                                                                <div
                                                                                                            class="widget-header m-t-20">
                                                                                                            <h4
                                                                                                                        class="widget-title">
                                                                                                                        categoria
                                                                                                            </h4>
                                    ...
                                    ?>
                                                ...
                                                <div class='col-md-9'>
                                                            ...
                                                            <div id="category" class="category-carousel hidden-xs">
                                                                        <div class="item">
                                                                                    <div class="image">
                                                                                                <img src="assets/images/banners/cat-banner-1.jpg"
                                                                                                            alt=""
                                                                                                            class="img-responsive">
                                                                                    </div>
                                                                                    <div class="container-fluid">
                                                                                                <div
                                                                                                            class="caption vertical-top text-left">
                                                                                                            <div
                                                                                                                        class="big-text">
                                                                                                                        <br />
                                                                                                            </div>
                                                            ...
                                                            <div class="search-result-container">
                                                                        <div id="myTabContent" class="tab-content">
                                                                                    <div class="tab-pane active "
                                                                                                id="grid-container">
                                                                                                <div
                                                                                                            class="category-product  inner-top-vs">
                                                                                                            <div
                                                                                                                        class="row">
                                                                                                                        <?php
                                                                                                                                                            ...
                                                                                                                                                            <div
                                                                                                                                                                        ...
                                                                                                                                                                        <div
                                                                                                                                                                                    ...
                                                                                                                                                                                    <span
                                                                                                                                                                                                class="price">
                                                                                                                                                                                                COP
                                                                                                                                                                                                <?php echo htmlentities(number_format($row['productPrice'], 0, ',', '.')); ?>
                                                                                                                                                                                    </span>
                                                                                                                                                                                    <span

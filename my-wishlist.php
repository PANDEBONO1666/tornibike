                                                                                                            ...
                                                                                                            <tr>
                                                                                                                        ...
                                                                                                                        <td
                                                                                                                                    ...
                                                                                                                                    <div
                                                                                                                                                class="price">
                                                                                                                                                COP
                                                                                                                                                <?php echo htmlentities(number_format($row['pprice'], 0, '', '.')); ?>
                                                                                                                                                <span></span>
                                                                                                                                    </div>
                                                                                                                        </td>
                                                                                                                        <td
                                                                                                                                    ...
                                                                                                                                    <a href="my-wishlist.php?page=product&action=add&id=<?php echo $row['pid']; ?>"
                                                                                                                                                class="btn-upper btn btn-primary">Añadir
                                                                                                                                                a
                                                                                                                                                la
                                                                                                                                                cesta</a>
                                                                                                                        </td>
                                                                                                                        <td
                                                                                                                                    class="col-md-2 close-btn">

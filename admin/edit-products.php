...
<?php echo htmlentities($row['productDescription']); ?>
                                                                                                                                    ...
                                                                                                                                    <div class="control-group">
                                                                                                                                                ...
                                                                                                                                                <div class="controls">
                                                                                                                                                            ...
                                                                                                                                                            <a href="update-image1.php?id=<?php echo $row['id']; ?>">Change
                                                                                                                                                                        Image</a>
                                                                                                                                                </div>
                                                                                                                                    </div>
                                                                                                                                    ...
                                                                                                                                    <div class="control-group">
                                                                                                                                                ...
                                                                                                                                                <div class="controls">
                                                                                                                                                            ...
                                                                                                                                                            <a href="update-image2.php?id=<?php echo $row['id']; ?>">Change
                                                                                                                                                                        Image</a>
                                                                                                                                                </div>
                                                                                                                                    </div>
                                                                                                                                    ...
                                                                                                                                    <div class="control-group">
                                                                                                                                                ...
                                                                                                                                                <div class="controls">
                                                                                                                                                            ...
                                                                                                                                                            <a href="update-image3.php?id=<?php echo $row['id']; ?>">Change
                                                                                                                                                                        Image</a>
                                                                                                                                                </div>
                                                                                                                                    </div>
                                                                                                                        <?php } ?>

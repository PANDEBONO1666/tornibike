                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                                    ...
                                                                                                                                    <td
                                                                                                                                                ...
                                                                                                                                                <?php echo number_format($price = $row['price'], 0, '.', '.'); ?>
                                                                                                                                    </td>
                                                                                                                                    <td
                                                                                                                                                class="cart-product-grand-total">
                                                                                                                                                <?php echo number_format($qty * $price, 0, '.', '.'); ?>
                                                                                                                                    </td>

                                    ...
                                    <div class="furniture-container homepage-container">
                                                                        ...
                                                                        <div id="hero" class="homepage-slider3">
                                                                                    <div id="owl-main"
                                                                                                ...
                                                                                                <div
                                                                                                            ...
                                                                                                            <div class="item"
                                                                                                                        style="background-image: url(assets/images/sliders/slider12.jpg);">
                                                                                                                        <!-- /.container-fluid -->
                                                                                                            </div>
                                                                                                            <!-- /.item -->
                                                                                                </div>
                                                                                                ...
                                                                                                <div
                                                                                                            ...
                                                                                                            <div class="item full-width-slider"
                                                                                                                        style="background-image: url(assets/images/sliders/slider13.jpg);">
                                                                                                            </div>
                                                                                                            <!-- /.item -->
                                                                                                </div>
                                                                                                <!-- /.full-width-slider -->
                                                                        ...
                                                                        <div class="info-boxes wow fadeInUp">
                                                                                    <div class="info-boxes-inner">
                                                                                                <div class="row">
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                                    ...
                                                                                                                                    <div
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                            class="col-xs-2">
                                                                                                                                                            <i
                                                                                                                                                                        class="icon fas fa-money-bill"></i>
                                                                                                                                                </div>
                                                                                                                                                <div
                                                                                                                                                            class="col-xs-10">
                                                                                                                                                            <h4
                                                                                                            ...
                                                                                                            <div
                                                                                                                        class="hidden-md col-sm-4 col-lg-4">
                                                                                                                        <div
                                                                                                                                    class="info-box">
                                                                                                                                    <div
                                                                                                                                                class="row">
                                                                                                                                                <div
                                                                                                                                                            class="col-xs-2">
                                                                                                                                                            <i
                                                                                                                                                                        class="icon fas fa-shipping-fast"></i>
                                                                                                                                                </div>
                                                                                                                                                <div
                                                                                                                                                            class="col-xs-10">
                                                                                                                                                            <h4
                                                                                                                                                                        class="info-box-heading orange">
                                                                                                                                                                        Envío
                                                                                                                                                                        gratis
                                                                                                                                                            </h4>
                                                                                                                                                </div>
                                                ...
                                                <div id="product-tabs-slider"
                                                            ...
                                                            <div class="more-info-tab clearfix">
                                                                        <h3 class="new-product-title pull-left">Featured
                                                                                    Products</h3>
                                                                        <ul class="nav nav-tabs nav-tab-line pull-right"
                                                                                    id="new-products-1">
                                                                                    <li class="active"><a href="#all"
                                                                                                            data-toggle="tab">Todo</a>
                                                                                    </li>
                                                                                    <li><a href="#piezas"
                                                                                                            data-toggle="tab">piezas</a>
                                                                                    </li>
                                                                                    <li><a href="#ciclas"
                                                                                                            data-toggle="tab">ciclas</a>
                                                                                    </li>
                                                                        </ul><!-- /.nav-tabs -->
                                                            </div>
                                                                                                                                    ...
                                                                                                                                    <div
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                            ...
                                                                                                                                                            <div
                                                                                                                                                                        ...
                                                                                                                                                                        <span
                                                                                                                                                                                    class="price">
                                                                                                                                                                                    <?php echo "COP " . htmlentities(number_format($row['productPrice'], 0, ',', '.')); ?>
                                                                                                                                                                        </span>
                                                                                                                                                                        <span
                                                                                                                                                                                    class="price-before-discount">
                                                                                                                                                                                    <?php echo "COP " . htmlentities(number_format($row['productPriceBeforeDiscount'], 0, ',', '.')); ?>
                                                                                                                                                                        </span>
                                                                                                                                                            </div>
                                                                                                                                                            <!-- /.product-price -->
